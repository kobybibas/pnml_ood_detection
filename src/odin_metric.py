...
def tpr95(name):
    ...
    T = 1
    cifar = load_file(
        '../outputs/features_densenet_cifar10_odin_20201210_125400/densenet_cifar10_cifar10_testset_outputs.npy')
    other = load_file(
        '../outputs/features_densenet_cifar10_odin_20201210_125400/densenet_cifar10_Imagenet_testset_outputs.npy')
...
metric('CIFAR-10', "Tiny-ImageNet (crop)")
